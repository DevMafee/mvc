...
INSERT INTO `categories` (`category_id`, `category_name`, `category_status`, `category_date`) VALUES
(1, 'salman', 1, '2019-09-15'),
(2, 'salman', 1, '2019-09-15'),
(3, 'sajib', 1, '2019-09-15');
...
--
ALTER TABLE `modules`
  MODIFY `modules_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
